  ...
  await Promise.all([
    ...
    prisma.student.upsert({
      ...
      create: {
        ...
        rollNumber: '10',
        parentName: 'Mr. Ali',
        parentPhone: '01612345679',
        address: 'Uttara, Dhaka',
      },
    }),
    prisma.student.upsert({
      where: { admissionNumber: 'STD004' },
      update: {},
      create: {
        ...
        parentPhone: '01512345679',
        address: 'Gulshan, Dhaka',
      },
    }),
    prisma.student.upsert({
      where: { admissionNumber: 'STD005' },
      update: {},
      create: {
        ...
        section: 'C',
        rollNumber: '15',
        parentName: 'Mr. Hossain',
        parentPhone: '01412345679',
